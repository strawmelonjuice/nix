...

{
  programs.wezterm = {
    ...
    extraConfig = ''
      ...
      -- Keybinds ------------------------------------------------------------------------------------------------------------- 
        ...
        local namePicker = act.PromptInputLine({
        ...
        local colorPicker = act.InputSelector({
          title = "Change Catppuccin flavor",
          choices = {
            { label = "tokyonight_night" },
            { label = "Breadog (Gogh)" },
          },
  ...
  xdg.configFile."wezterm/bar.lua" = {
    text = ''
      -- stole this from isabelroses, who seems to have stolen it from https://github.com/nekowinston/wezterm-bar
      -- I hate when I have this as a separate file so may change this up later.
